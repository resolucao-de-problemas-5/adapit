...
public class PessoaServiceDAOHibernate extends GenericDAOHibernate implements
		...
		if (p.getTipoPessoa() instanceof Fisica){	
			...
			if (p.getId() < 0){//� novo usu�rio	
				...
				if (cpf > 0 || rg > 0 || email > 0){
					...
					if (cpf > 0) ht.put("cpf","est� repetida em outro registro. N�o pode haver valores repetidos.");
					if (rg > 0) ht.put("rg","est� repetida em outro registro. N�o pode haver valores repetidos.");
					if (email>0) ht.put("email","est� repetida em outro registro. N�o pode haver valores repetidos.");
			...
			if (p.getId() < 0){//� novo usu�rio	
				...
				if (cnpj > 0 || inscricaoEstadual > 0 || email > 0){
					Hashtable<String,String> ht = new Hashtable<String,String>();
					if (cnpj > 0) ht.put("cnpj","est� repetida em outro registro. N�o pode haver valores repetidos.");
					if (inscricaoEstadual > 0) ht.put("inscricaoEstadual","est� repetida em outro registro. N�o pode haver valores repetidos.");
					if (email>0) ht.put("email","est� repetida em outro registro. N�o pode haver valores repetidos.");
	...
	public Usuario saveOrUpdate(Usuario user, Pessoa p, Endereco ender)
		...
		try{
			...
			//Checa se dados n�o ser�o replicados
			if (p.getTipoPessoa() instanceof Fisica){	
			...
			ex.printStackTrace();
			Hashtable<String,String> ht = new Hashtable<String,String>();
			ht.put("cnpj","pode estar repetida em outro registro. N�o pode haver valores repetidos.");
			ht.put("inscricaoEstadual","pode estar repetida em outro registro. N�o pode haver valores repetidos.");
			ht.put("cpf","pode estar repetida em outro registro. N�o pode haver valores repetidos.");
			ht.put("rg","pode estar repetida em outro registro. N�o pode haver valores repetidos.");
			ht.put("email","pode estar repetida em outro registro. N�o pode haver valores repetidos.");
				...
				if (p.getTipoPessoa() instanceof Fisica) {
					...
					if (cpf > 0 || rg > 0 || email > 0) {
						...
						if (cpf > 0)
							ht
									.put("cpf",
											"est� repetida em outro registro. N�o pode haver valores repetidos.");
						if (rg > 0)
							ht
									.put("rg",
											"est� repetida em outro registro. N�o pode haver valores repetidos.");
