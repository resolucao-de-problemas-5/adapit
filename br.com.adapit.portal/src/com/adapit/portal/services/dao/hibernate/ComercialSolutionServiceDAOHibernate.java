...
/*	public List listTrainingSolutionsAccordingTo(String descricao, StringQueryKind descKind,
	...
	*/
	...
	public ComercialSolution saveOrUpdate(ComercialSolution solution) throws Exception {
		...
		try {
			...
			try {
				s.beginTransaction();
				if(solution.getId()>0){
					System.out.println("Salvando altera��es em " + solution.getId() + " " + solution.getClass().getSimpleName());
	...
	/**
	 * Remove o solution que cont�m o identificador passado como argumento
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/**
	 * Remove todos os solutions que perten�am a um lote
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/**
	 * Retorna um solution pela descri��o
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/**
	 * Retorna um solution e tamb�m as propriedades em cascata
	 */
	@SuppressWarnings("unchecked")
	@Override
