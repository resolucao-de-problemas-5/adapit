...
public class NewsServiceDAOHibernate extends GenericDAOHibernate implements
	...
	/**
	 * Retorna todos os newss em que a descri��o contenha o valor passado
	 * como argumento
	 */
	@Override
	...
	/**
	 * Retorna o news em que a descri��o inicia pelo valor passado como
	 * argumento
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/**
	 * Retorna o news em que a descri��o termina pelo valor passado como
	 * argumento
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/**
	 * Retorna o news em que a descri��o � igual ao valor passado como
	 * argumento
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/**
	 * Remove o news que cont�m o identificador passado como argumento
	 */
	@Override
	@SuppressWarnings("unchecked")
...
/*		Session s = LocalServicesUtility.getInstance().openSession();
	...
	/**
	 * Retorna um news e tamb�m as propriedades em cascata
	 */
	@SuppressWarnings("unchecked")
