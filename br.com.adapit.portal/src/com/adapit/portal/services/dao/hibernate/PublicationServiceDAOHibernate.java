...
public class PublicationServiceDAOHibernate extends GenericDAOHibernate implements
	...
	/**
	 * Retorna todos os publications em que a descri��o contenha o valor passado
	 * como argumento
	 */
	@Override
	...
	/**
	 * Retorna o publication em que a descri��o inicia pelo valor passado como
	 * argumento
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/**
	 * Retorna o publication em que a descri��o termina pelo valor passado como
	 * argumento
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/**
	 * Retorna o publication em que a descri��o � igual ao valor passado como
	 * argumento
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/**
	 * Remove o publication que cont�m o identificador passado como argumento
	 */
	@Override
	@SuppressWarnings("unchecked")
...
/*		Session s = LocalServicesUtility.getInstance().openSession();
	...
	public List<Imagem> getImagensByPublicationId(int id) throws Exception {
		try {
			...
			try {
				...
				}//else System.out.println("ids � nulo");
	...
	/**
	 * Retorna um publication pela descri��o
	 */
	@Override
	@SuppressWarnings("unchecked")
	...
	/**
	 * Retorna um publication e tamb�m as propriedades em cascata
	 */
	@SuppressWarnings("unchecked")
