...
public class FormacaoCadastreForm extends JPanel {
		...
		try {
			...
			if (formacao != null) {
				...
				int conf = JOptionPane.showConfirmDialog(FormacaoCadastreForm.this,
						"A forma��o de codigo " + num + " nao existe. Voce deseja cri�-la?", "Criar nova forma��o",
	...
	public FormacaoTreinamento validateFormacaoForm() throws Exception {
		...
		if (!validateFormacaoBean())
			throw new Exception("Forma��o Invalida");
	...
	protected JLabel getCodigoLabel() {
		if (codigoLabel == null) {
			codigoLabel = new JLabel("Codigo da Forma��o");
	...
	protected JLabel getDescricaoTextAreaLabel() {
		if (descricaoTextAreaLabel == null) {
			descricaoTextAreaLabel = new JLabel("Objetivo/Descricao da Forma��o:");
	...
	protected JTabbedPane getCadastramentoTabbedPane() {
		if (cadastramentoTabbedPane == null) {
			...
			cadastramentoTabbedPane.add(getTreinamentosPanel(), "Dados da Forma��o");
			cadastramentoTabbedPane.add(getOutrasInformacoesPanel(), "Outras Informa�oes");
		}
					...
					if (training != null) {
						...
						try {
							...
							AdapitVirtualFrame.getInstance()
									.showOperationSucess("Adi��o de Treinamentos em Forma�oes", "Treinamento "
											+ ip.getTrainingSolution().getId()
											+ " adicionado! Atualize os dados do item deste treinamento");
						} catch (Exception ex) {
							ex.printStackTrace();
							AdapitVirtualFrame.getInstance().showErrorDialog("Adi��o de Treinamentos em Forma�oes",
									"Nao foi possivel adicionar este treinamento na forma��o");
						}
				...
				try {
					...
					if (p != null) {
						...
						logErrorPanel.addAlert(
								"Nao esque�a de atualizar o valor e a descri��o da forma��o! salve as altera�oes clicando no bot�o 'Atualizar Forma��o'");
			...
			try {
				...
				if (desc != null) {
					int resp = JOptionPane.showConfirmDialog(FormacaoCadastreForm.this,
							"Voce quer retirar o treinamento " + desc + " da forma��o " + formacao.getCodigo() + "?",
							"Remover Treinamento da Forma��o", JOptionPane.YES_NO_OPTION);
					if (resp == JOptionPane.YES_OPTION) {
						try {
							...
							JOptionPane.showMessageDialog(FormacaoCadastreForm.this, "O treinamento nao foi removido," +
									" pois esta sendo usado em outras forma�oes!" + '\n' +
									" � permitido que voce remova somente o item da forma��o." + '\n'
									+ " Favor repetir a opera��o.", "Problema ao remover treinamento",
	...
	protected JButton getAtualizarFormacoesButton() {
		if (atualizarFormacoesButton == null) {
			atualizarFormacoesButton = new JButton("Atualizar Forma��o");
			...
			atualizarFormacoesButton.addActionListener(new AbstractAction() {
				public void doAction(ActionEvent evt) {
					try {
						...
						AdapitVirtualFrame.getInstance().showOperationSucess("Cadastro de forma�oes",
								"Operacao de cadastro realizada com sucesso!");
						editarFormacaoSelecionada();
					} catch (Exception e) {
						AdapitVirtualFrame.getInstance().showErrorDialog("Formulario de cadastro de forma�oes",
	...
	protected JButton getNovaFormacaoButton() {
		if (novaFormacaoButton == null) {
			novaFormacaoButton = new JButton("Nova Forma��o");
	...
	protected JButton getRemoverFormacaoButton() {
		if (removerFormacaoButton == null) {
			removerFormacaoButton = new JButton("Remover Forma��o");
	...
	public class RemoverFormacaoAction extends AbstractAction {
		public void doAction(java.awt.event.ActionEvent e) {
			...
			if (l != null) {
				int resp = JOptionPane.showConfirmDialog(FormacaoCadastreForm.this,
						"Apagar a forma��o " + l.getCodigo(), "Apagar Forma��o", JOptionPane.YES_NO_OPTION);
				if (resp == JOptionPane.YES_OPTION) {
					try {
	...
	private JButton getEditarLoteButton() {
		if (editarLoteButton == null) {
			...
			editarLoteButton.setText("Editar Forma��o");
	...
	private JLabel getResumoLabel() {
		if (resumoLabel == null) {
			...
			resumoLabel.setText("Tecnologia da Forma��o:");
		}
		return resumoLabel;
	}
	...
	private JLabel getNomeFormacaoLabel() {
		if (nomeFormacaoLabel == null) {
			...
			nomeFormacaoLabel.setText("Nome da Forma��o:");
		}
				...
				public void actionPerformed(ActionEvent arg0) {
					if (formacao.getId() != 0) {
						...
						JOptionPane.showMessageDialog(FormacaoCadastreForm.this,
								"Primeiro � preciso cadastrar a forma��o!", "Adicionar imagem",
	...
	public void anexarImagem() {
		try {
			if (anexar == null) {
				anexar = new JButton("Anexar na forma��o");
		...
		public void actionPerformed(ActionEvent evt) {
			...
			if (rows != null) {
				try {
					...
					getSmallLabelImage().setIcon(im.getSmallImageIcon(false));
					getSmallLabelImage().updateUI();
					AdapitVirtualFrame.getInstance().showOperationSucess("Anexar Imagem em Forma��o",
	...
	private class TreinamentosList extends JXTable {
		...
		private class ProdutosListModel extends DefaultTableModel {
			...
			public ProdutosListModel(Object[][] values) {
				...
				super(
						values,
						new String[] { "Treinamento", "Categoria", "Valor Unit�rio", "Carga Horaria", "Criado em",
								"Ordem" });
			}
