...
public class TurmaCadastreForm extends JPanel {
	...
	protected JTabbedPane getTabbedPane() {
		if (tabbedPane == null) {
			...
			tabbedPane.add(getCondPartTab(), "Instru�oes de Participacao");
	...
	protected JPanel getBaseTab() {
		...
		if (baseTab == null) {
			...
			instrucoesAosParticipantesLabel.setText("Instru�oes aos Participantes:");
	...
	protected JLabel getFormacaoLabel() {
		if (formacaoLabel == null) {
			formacaoLabel = new JLabel("Forma��o:");
	...
	protected JButton getEditarFormacaoButton() {
		if (editarFormacaoButton == null) {
			editarFormacaoButton = new JButton("Editar Forma��o");
	...
	protected JPanel getDataHoraPanel() {
		if (dataHoraPanel == null) {
			...
			numeroMaxParticipantesLabel.setText("Numero M�ximo de Participantes:");
	...
	protected JLabel getRealizacaoLabel() {
		if (realizacaoLabel == null) {
			realizacaoLabel = new JLabel("Realiza��o:");
	...
	public TurmaTreinamento validateTurmaForm() throws Exception {
		...
		if (cond == null) {
			...
			reportInvalidField("turmaTreinamento.condicaoParticipacaoTreinamento",
					"Voce deve selecionar uma condi��o de participa��o");
		...
		if (presencial1 == null) {
			invalid = true;
			reportInvalidField("dataTreinamento", "A data do treinamento � um campo obrigat�rio");
		}
		...
		if (turma.getDataEncerramento() == null || turma.getDataTreinamento() == null) {
			invalid = true;
			reportInvalidField("dataTreinamento", "A data do treinamento � um campo obrigat�rio");
			reportInvalidField("dataEncerramento", "A data de encerramento � um campo obrigat�rio");
		}
				...
				public void doAction(java.awt.event.ActionEvent e) {
					try {
						...
						AdapitVirtualFrame.getInstance().showErrorDialog("Cadastro de Condicoes",
								"Problema ao cadastrar a condi��o");
					}
				}
			});
		}
	...
	private JButton getRefreshFormacoesButton() {
		if (refreshFormacoesButton == null) {
			...
			refreshFormacoesButton.setToolTipText("Atualizar a lista de forma�oes");
	...
	private JButton getRefreshEnderecoButton() {
		if (refreshEnderecoButton == null) {
			...
			refreshEnderecoButton.setToolTipText("Atualizar a lista de ender�os");
	...
	private JButton getEditarCondicaoButton() {
		if (editarCondicaoButton == null) {
			...
			editarCondicaoButton.setText("Editar o Pr�-Requisito");
	...
	private JButton getCriarPorFormacaoButton() {
		if (criarPorFormacaoButton == null) {
			...
			criarPorFormacaoButton.setText("Criar Pela Forma��o");
			...
			buscarButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					if (turma.getId() != 0) {
						...
						JOptionPane.showMessageDialog(TurmaCadastreForm.this, "Primeiro � preciso cadastrar a turma!",
