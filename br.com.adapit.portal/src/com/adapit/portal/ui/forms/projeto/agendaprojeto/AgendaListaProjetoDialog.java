	...
	protected JTabbedPane getTabbedPane() {
		...
		if (tabbedPane == null) {
			...
			tabbedPane.add(getHistoricoLancesCleintesPanel(),
					"Hist�rico da Participacao de Clientes em Leiloes");
		}
		return tabbedPane;
	}
	...
	protected JButton getVerHistoricoClienteButton() {
		...
		if (verHistoricoClienteButton == null) {
			verHistoricoClienteButton = new JButton(
					messages
							.getMessage(
									"com.adapit.portal.ui.forms.baseleilao.AgendaListaLoteDialog.VerHist�ricodoCliente"));
			...
			public UsuarioHistoricoLancezTableModel(Object[][] values) {
				...
				super(
						...
						new String[] {
								...
								messages
										.getMessage(
												"com.adapit.portal.ui.forms.baseleilao.AgendaListaLoteDialog.�ltimoLance") });
			}
