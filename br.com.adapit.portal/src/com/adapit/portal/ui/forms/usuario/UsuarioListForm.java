	...
	protected JLabel getUserRuleComboBoxLabel() {
		...
		if (userRuleComboBoxLabel == null) {
			userRuleComboBoxLabel = new JLabel(
					messages
							.getMessage(
									"com.adapit.portal.ui.forms.manutencaousuario.UsuarioListForm.Cliente/Funcion�rio"));
	...
	protected JButton getListarByDeactivatedButton() {
		...
		if (listarByDeactivatedButton == null) {
			listarByDeactivatedButton = new JButton(
					messages
							.getMessage(
									"com.adapit.portal.ui.forms.manutencaousuario.UsuarioListForm.J�foramdesativados"));
	...
	protected JButton getListarByItensPostadosVendaDiretaButton() {
		...
		if (listarByItensPostadosVendaDiretaButton == null) {
			listarByItensPostadosVendaDiretaButton = new JButton(
					messages
							.getMessage(
									"com.adapit.portal.ui.forms.manutencaousuario.UsuarioListForm.J�postaramitensparavendadireta"));
			...
			if (elements != null && elements.size() > 0) {
				...
				while (it.hasNext()) {
					...
					if (!(obj instanceof Usuario))
						System.out.println(i + " nao � inst�ncia de usuario " + obj.getClass().getName());
					if (obj instanceof Usuario) {
						try {
