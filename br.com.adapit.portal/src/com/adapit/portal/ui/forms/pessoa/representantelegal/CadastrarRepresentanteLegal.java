...
public class CadastrarRepresentanteLegal extends JPanel {
	...
	private void updateImage() {
		if (getRepresentanteLegal().getLogotipo() != null)
			try {
				try {
					getRepresentanteLegal().getLogotipo().setSmallImageBytes(RemoteImagemService.getInstance()
							.getSmallImageBytesFromImage(getRepresentanteLegal().getLogotipo().getId()));
				} catch (Exception e) {
					e.printStackTrace();
				}
