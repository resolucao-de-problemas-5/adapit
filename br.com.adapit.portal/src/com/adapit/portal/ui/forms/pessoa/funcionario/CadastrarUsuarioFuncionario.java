...
public class CadastrarUsuarioFuncionario extends JPanel {
	...
	protected JPanel getDadosPessoaisPanel() {
		...
		if (dadosPessoaisPanel == null) {
			...
			// dadosPessoaisPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder("Dados
			// Pessoais")));
	 ...
	 * compComboBox3Label = new JLabel(messages.getMessage(
	 * "com.adapit.portal.ui.forms.manutencaousuario.CadastrarUsuarioAdmin.TipodePessoa"
	 * ));
	 ...
	 * mostrarTipoPessoaButton = new JButton(messages.getMessage(
	 * "com.adapit.portal.ui.forms.manutencaousuario.CadastrarUsuarioAdmin.Mostrarosdadosdotipodepessoa"
	 * ));
	...
	protected JButton getDeleteButton() {
		...
		if (deleteButton == null) {
			deleteButton = new JButton(
					messages.getMessage("com.adapit.portal.ui.forms.manutencaousuario.CadastrarUsuarioAdmin.Apagar"));
			deleteButton.setSize(new java.awt.Dimension(80, 22));
			// deleteButton.setText("Destaivar Usuario");
